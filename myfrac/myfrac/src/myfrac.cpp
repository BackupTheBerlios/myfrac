...
void MyFracWindow::setPosition(double px, double py, double zoom, double angle)
{
...
void MyFracWindow::onGradientEdit()
{
...
void MyFracWindow::onDefaultView()
{
	setPosition(_juliaMode ? 0.0 : -0.7, 0.0, 0.0, 0.0);
}

void MyFracWindow::onViewBack()
{
...
void MyFracWindow::onViewForward()
{
...
void MyFracWindow::customEvent(QCustomEvent* e)
{
...
void MyFracWindow::readPosition()
{
	double posX = _posX;
	double posY = _posY;
	double zoom = _zoom;
...
void MyFracWindow::setScrollMode(int mode)
{
	if (mode == 0) {
		_scrollTimer->stop();
...
void MyFracWindow::setScrollSpeed(int speed)
{
...
void MyFracWindow::setHeightScale(int scale)
{
...
void MyFracWindow::updatePosition()
{
	QString str;
...
void MyFracWindow::updateShowActions()
{
